      ...
      <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 mb-8">
         <div className="flex flex-col lg:flex-row gap-6 items-end">
             ...
             <div className="flex gap-4">
                {/* 🟢 VALIDACIÓN: Limpia fechaFin si fechaInicio la supera */}
                <input 
                  type="date" 
                ...
                />
                {/* 🟢 VALIDACIÓN: Atributo min para bloquear fechas anteriores */}
                <input 
                  type="date" 
                  className="input input-bordered input-sm bg-slate-50" 
            ...
            <tbody className="divide-y divide-slate-100">
              {!loading && facturas.map((recibo: Recibo) => (
                <tr key={recibo.Cod_Recibo} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="py-4">
                    {recibo.MetodoPago?.Nombre_Metodo ? (
                      ...
                      <span className="text-[10px] text-slate-300 italic uppercase">No especificado</span>
                    )}
                  </td>
